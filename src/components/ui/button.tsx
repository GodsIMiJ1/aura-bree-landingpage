  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground hover:bg-primary-glow border border-primary/50 shadow-sovereign hover:shadow-glow animate-glow-pulse font-semibold",
        sovereign: "bg-gradient-sovereign text-primary-foreground border border-primary/30 hover:border-primary shadow-sovereign transition-glow",
        medical: "bg-gradient-medical text-accent-foreground border border-accent/30 hover:border-accent transition-smooth",
      },
      size: {
